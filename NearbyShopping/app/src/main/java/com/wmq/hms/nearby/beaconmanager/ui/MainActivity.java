...
import com.wmq.hms.nearby.beaconmanager.beaconbase.ServiceAccountSignInClient;
import com.wmq.hms.nearby.beaconmanager.beaconbase.restfulapi.BeaconRestfulClient;
import com.wmq.hms.nearby.beaconmanager.canteen.permission.PermissionHelper;
import com.wmq.hms.nearby.beaconmanager.canteen.permission.PermissionInterface;
import com.wmq.hms.nearby.beaconmanager.canteen.utils.BluetoothCheckUtil;
import com.wmq.hms.nearby.beaconmanager.canteen.utils.GpsCheckUtil;
import com.wmq.hms.nearby.beaconmanager.canteen.utils.NetCheckUtil;
...
public class MainActivity extends AppCompatActivity implements PermissionInterface {
    ...
    private void initView() {
        ...
        merchants.setOnClickListener(v -> startActivity(new Intent(this, MerchantsActivity.class)));
    }
    ...
    private void checkAndRequestPermissions() {
        int PERMISSION_REQUEST_CODE = 940;
    ...
    private void login() {
        ...
        try {
            InputStream inputStream = getResources().getAssets().open("736430079244704750103286205private.json");
