...
public class PermissionHelper {
    ...
    private com.huawei.hms.nearbyconnectiondemo.utils.permission.PermissionInterface mPermissionInterface;

    public PermissionHelper(@NonNull Activity activity,
                            @NonNull com.huawei.hms.nearbyconnectiondemo
                                    .utils.permission.PermissionInterface permissionInterface) {
        mActivity = activity;
    ...
    public void requestPermissions() {
        String[] deniedPermissions =
                com.huawei.hms.nearbyconnectiondemo.utils.permission.PermissionUtil.getDeniedPermissions(
                        mActivity, mPermissionInterface.getPermissions());
        if (deniedPermissions != null && deniedPermissions.length > 0) {
            com.huawei.hms.nearbyconnectiondemo.utils.permission.PermissionUtil.requestPermissions(
