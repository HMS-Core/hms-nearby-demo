...
import com.huawei.hms.nearby.stores.BuildConfig;
import com.huawei.hms.nearby.stores.beaconbase.model.Attachment;
import com.huawei.hms.nearby.stores.beaconbase.model.BeaconInfo;
import com.huawei.hms.nearby.stores.beaconbase.model.Namespace;
import com.huawei.hms.nearby.stores.beaconbase.model.QueryBeaconListParam;
...
public class BeaconRestfulClient {
    ...
    private static final String TAG = "BeaconRestfulClient";
    ...
    private CommHeaderIntercept commHeaderIntercept;
    ...
    private final ScheduledExecutorService scheduledExecutorService = ScExecutors.newScheduledThreadPool(1);
    ...
    public void setAccessToken(String accessToken) {
        ...
        commHeaderIntercept.setAuthorization(accessToken);
    }
    ...
    public long queryBeaconRegisterStatus(String beaconId, Callback<BeaconStatusRes> callback) {
        ...
        Log.d(TAG, "queryBeaconRegisterStatus: " + beaconId);
    ...
    public long registerBeacon(BeaconInfo beaconInfo) {
        ...
        Log.d(TAG, "registerBeacon: " + beaconInfo.getBeaconId());
        BeaconInfoCloudReqParam param = new BeaconInfoCloudReqParam(beaconInfo);
        CloudCb request = new CloudCb();
    ...
    public long updateBeacon(BeaconInfo beaconInfo) {
        ...
        Log.d(TAG, "updateBeaconInfo: " + beaconInfo.getBeaconId());
        BeaconInfoCloudReqParam param = new BeaconInfoCloudReqParam(beaconInfo);
        CloudCb request = new CloudCb();
    ...
    public long unRegisterBeacon(String beaconId) {
        ...
        Log.d(TAG, "deleteBeacon: " + beaconId);
        CloudCb request = new CloudCb();
    ...
    public long activeBeacon(String beaconId) {
        ...
        Log.d(TAG, "activeBeacon: " + beaconId);
    ...
    public long deactiveBeacon(String beaconId) {
        ...
        Log.d(TAG, "deactiveBeacon: " + beaconId);
        BeaconIdCloudReqParam param = new BeaconIdCloudReqParam(beaconId);
        CloudCb request = new CloudCb();
    ...
    public long abandonBeacon(String beaconId) {
        ...
        Log.d(TAG, "abandonBeacon: " + beaconId);
        BeaconIdCloudReqParam param = new BeaconIdCloudReqParam(beaconId);
        CloudCb request = new CloudCb();
    ...
    public BeaconInfo queryBeaconInfo(String beaconId) {
        ...
        Log.d(TAG, "queryBeaconInfo: " + beaconId);
        QueryBeaconInfoCb request = new QueryBeaconInfoCb();
    ...
    public void queryBeaconList(QueryBeaconListParam param, Callback<QueryBeaconListRes> callback) {
        ...
        Log.d(TAG, String.format(Locale.ENGLISH, "queryBeaconList, upOrDown:%d, seq:%d", param.getUpOrDown(),
            param.getSequence()));
    ...
    public ArrayList<Attachment> queryBeaconAttachment(String beaconId) {
        ...
        Log.d(TAG, "queryBeaconAttachment: " + beaconId);
        QueryAttachmentCb request = new QueryAttachmentCb();
    ...
    public Attachment addAttachment(String beaconId, Attachment attachment) {
        ...
        UpdateAttachmentCb request = new UpdateAttachmentCb();
    ...
    public ArrayList<Namespace> queryNamespace() {
        ...
        Log.d(TAG, "queryNamespace");
        QueryNamespaceCb request = new QueryNamespaceCb();
