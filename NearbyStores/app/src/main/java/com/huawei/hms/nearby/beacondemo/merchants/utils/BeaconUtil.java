...
package com.huawei.hms.nearby.beacondemo.merchants.utils;
...
public class BeaconUtil {
    ...
    private static final double DECAY_FACTOR = 2.5d;

    private static final double POW_BASE = 10d;
    ...
    public static String bytesToBase64Str(byte[] data) {
        ...
        return new String(encodeData, Charset.forName("UTF-8"));
    }
    ...
    public static byte[] base64StrToBytes(String strBase64) {
        ...
        return Base64.decode(strBase64.getBytes(Charset.forName("UTF-8")), Base64.NO_WRAP);
    }
}
