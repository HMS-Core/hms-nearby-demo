...
public class ServiceAccountSignInClient {
    ...
    public int signIn() {
        if(TextUtils.isEmpty(issuer)){
            Log.e(TAG, "issuer is null.");
            return -1;
        }
        if(TextUtils.isEmpty(keyId)){
            Log.e(TAG, "keyId is null.");
            return -1;
        }
        if(TextUtils.isEmpty(privateKey)){
            Log.e(TAG, "privateKey is null.");
            return -1;
        }
        if(TextUtils.isEmpty(audience)){
            Log.e(TAG, "audience is null.");
            return -1;
        }
