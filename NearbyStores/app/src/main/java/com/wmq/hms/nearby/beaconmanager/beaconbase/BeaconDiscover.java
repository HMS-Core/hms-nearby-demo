...
import com.wmq.hms.nearby.beaconmanager.beaconbase.blebeacon.BeaconScanCb;
import com.wmq.hms.nearby.beaconmanager.beaconbase.blebeacon.BeaconScaner;
...
import com.wmq.hms.nearby.beaconmanager.beaconbase.restfulapi.BeaconStatusRes;
import com.wmq.hms.nearby.beaconmanager.softbeacon.Conversion;
...
public class BeaconDiscover {
    ...
    public class QueryBeaconStatusCb implements Callback<BeaconStatusRes> {
        ...
        public void onResponse(Call<BeaconStatusRes> call, Response<BeaconStatusRes> response) {
            ...
            } else if (sts == BEACON_UNREGISTER && !TextUtils.equals(beacon.getHexId(), deviceId.toLowerCase())) {
