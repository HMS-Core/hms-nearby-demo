 ...
 * @since 2019-11-18
 */
public class QueryBeaconInfoRequest implements Callback<QueryBeaconInfoRes> {
    private static final int FAIL_UNKNOW = -1;

    private static final int FAIL_TIMEOUT = -5;

    private static final String TAG = QueryBeaconInfoRequest.class.getSimpleName();
