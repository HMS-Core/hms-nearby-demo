...
5. [NearbyDevices](https://github.com/HMS-Core/hms-nearby-demo/tree/master/NearbyDevices): The package contains an Android Studio project that demonstrates how to develop a message app that can use both Nearby Message and third-party mobile services.
...
7. [NearbySimpleconnection](https://github.com/HMS-Core/hms-nearby-demo/tree/master/NearbySimpleconnection): The package contains an Android Studio project that demonstrates how to implement file sharing only by adding two lines of code.
